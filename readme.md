...
- [DEBIAN](#debian)
	- [Download ISO](#download-iso)
		- [Set up the network on VM settings](#set-up-the-network-on-vm-settings)
		- [Mandatory](#mandatory)
			- [Install](#install)
				...
				- [Configure the package manager](#configure-the-package-manager)
					...
					- [Archive mirror country](#archive-mirror-country)
					- [Proxy](#proxy)
				- [Configuring popularity-contest](#configuring-popularity-contest)
				- [Software selection](#software-selection)
				- [Configuring grub-pc](#configuring-grub-pc)
				- [COMPLETE](#complete)
