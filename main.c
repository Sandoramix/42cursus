...
/*   Updated: 2023/10/26 16:47:00 by odudniak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	ft_printf("\t1_2_3:\t[%% %%%% %%%%%%]\n");
	ft_printf("\nMIXED DATA:\n");
	ft_printf("\nLEN CHECK = %s", ft_printf("\t[%c%i%s%d%c%u%c%x%c%X%c%p%%]\n", ' ', 42, " is equal to ", 42, ' ', 42, ' ', 42, ' ', 42, ' ', 42, ' ', (void *) 42) == 37 ? "\033[32mOK\033[0;39m" : "\033[31mKO\033[0;39m");
	...
	printf("\t1_2_3:\t[%% %%%% %%%%%%]\n");
	printf("\nMIXED DATA:\n");
	printf("\nLEN CHECK = %s", printf("\t[%c%i%s%d%c%u%c%x%c%X%c%p%%]\n", ' ', 42, " is equal to ", 42, ' ', 42, ' ', 42, ' ', 42, ' ', 42, ' ', (void *) 42) == 37 ? "\033[32mOK\033[0;39m" : "\033[31mKO\033[0;39m");
