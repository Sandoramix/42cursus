...
{
	std::cout << "[CT][DEFAULT]\tconstructor\tname: " << this->name << std::endl;
}

ClapTrap::ClapTrap(std::string name) : name(name), hitPoints(10), energyPoints(10), attackDamage(0)
{
	std::cout << "[CT]\t\tconstructor\tname: " << this->name << std::endl;
}
...
ClapTrap::ClapTrap(ClapTrap &clapTrap)
{
	...
	std::cout << "[CT][COPY]\tconstructor\tname: " << this->name << std::endl;
}

ClapTrap::~ClapTrap()
{
	std::cout << "[CT]\t\tdestructor\tname: " << this->name << std::endl;
}
...
ClapTrap &ClapTrap::operator=(ClapTrap &ct)
{
	...
	std::cout << "[CT][COPY]\tassignment\told name: " << oldname << "\tname: " << this->name << std::endl;
	return *this;
}
