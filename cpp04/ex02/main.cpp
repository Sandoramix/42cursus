...
void myTests()
{
	// This is commented because Animal Class cannot be instanced anymore.
	// "A class that contains at least one pure function is considered as abstract, therefore it cannot create any instance of itself"
	//{
